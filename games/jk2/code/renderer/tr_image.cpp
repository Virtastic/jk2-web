						  ...
						  int *pUploadWidth, int *pUploadHeight )
{
	...
	// idTech3-web: the data below is always uploaded as GL_RGBA/GL_UNSIGNED_BYTE, and WebGL1
	// requires internalformat == that pixel format. The GL 1.x component-count shorthands
	// (3/4), the sized formats (GL_RGB5/8, GL_RGBA4/8) and the S3TC compressed enums selected
	// above are all INVALID_VALUE here → the texture never uploads and samples as solid black.
	// With the world's lightmap modulate that blacks out the entire scene. Same fix the
	// RTCW/Wolf:ET renderer layer carries.
	*pformat = GL_RGBA;
#endif
