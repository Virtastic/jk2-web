...
{ 
	...
	// idt3-web: the RoQ pixels are uploaded as GL_RGBA; this packs A=0. On desktop the
	// cinematic draw ignores alpha, but WebGL's LEGACY_GL_EMULATION blend/texenv state
	// respects it, so an A=0 frame renders fully transparent (black). Force A=0xff.
