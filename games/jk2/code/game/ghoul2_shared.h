...
#pragma warning (pop)
#pragma warning (disable:4503)	// decorated name length xceeded, name was truncated
// idTech3-web: `using namespace std;` pulled std::move into scope, which is ambiguous
// with the game's file-scope `move` variables under C++11+. Import only what's used.
using std::vector;
using std::map;
/*
Ghoul2 Insert End
