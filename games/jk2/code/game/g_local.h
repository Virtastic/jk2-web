...
typedef	map < string, int, less<string> >		entlist_t;	// idTech3-web: MSVC6 allocator arg mismatched value_type
typedef map < string, pscript_t*, less<string> >	bufferlist_t;	// idTech3-web: same
