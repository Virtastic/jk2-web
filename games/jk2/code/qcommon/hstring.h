...
// idTech3-web: narrow the using-directive — broad `using namespace std;` pulls
// std::forward/left/right etc. into scope, colliding with the game code's vec3_t
// forward/right/up globals under emscripten's libc++.
#include <string>
#include <vector>
#include <list>
#include <map>
...
class hmap : public map<K,V,Compare,CMapPool<pair<const K,V> > >{};	// idTech3-web: libc++ requires allocator value_type == pair
