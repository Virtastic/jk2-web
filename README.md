...
<p>
  <a href="https://jk2.virtastic.app">▶ Play now</a> ·
  <a href="https://discord.gg/PzFfDkbSue">Discord</a> ·
  <a href="https://www.youtube.com/@Virtastic-Apps">YouTube</a> ·
  <a href="https://github.com/Virtastic/jk2-web/releases">Releases</a> ·
  <a href="https://github.com/Virtastic/jk2-web/issues">Issues</a>
</p>

A WebAssembly port of Raven Software's **original 2002 GPL source release**, compiled with
...
- **Bring your own copy** — point the picker at the `GameData/base` folder of a legal install and
  select the `assets*.pk3` files (`assets0`, `assets1`, `assets2`, `assets5`). They are read
...
docker run --rm -p 8080:80 jk2-web # http://localhost:8080
```
...
| Path | What it is |
|---|---|
| `games/jk2/` | Raven's pristine GPL drop + the `__EMSCRIPTEN__`-guarded port commits |
...
| `play/jk2/` | `index.html` (the game page) and `launcher.html`. Built `.js`/`.wasm` are gitignored |
...
- Engine code under `games/jk2/` — Copyright (C) 2002 Activision / Raven Software, released by
...
- **[GitHub Discussions](https://github.com/Virtastic/jk2-web/discussions)** — longer-form
